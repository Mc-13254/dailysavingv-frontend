...
export const TransactionAPI = {
  ...
  requestReversal: (payload) => client.post('/api/transaction/reversal-requests', payload),
  reversalRequests: (params) => client.get('/api/transaction/reversal-requests', { params }),
  approveReversal: (id) => client.post(`/api/transaction/reversal-requests/${id}/approve`),
  rejectReversal: (id, reason) => client.post(`/api/transaction/reversal-requests/${id}/reject`, { reason }),
  executeReversal: (id, receiptNumber) => client.post(`/api/transaction/reversal-requests/${id}/execute`, { receiptNumber }),
...
export const FraudAPI = {
  transactions: (params) => client.get('/api/fraud/transactions', { params }),
  detail: (id) => client.get(`/api/fraud/transactions/${id}`),
  review: (id, reviewStatus, comment) => client.post(`/api/fraud/transactions/${id}/review`, { reviewStatus, comment }),
  stats: () => client.get('/api/fraud/stats'),
};
